					...
					<div class="_overflow _table_div">
						<table class="_table">
							...
							<tr v-for="(category, i) in categoryLists" :key="i" v-if="categoryLists.length">
								...
								<td>
									<Button type="info" size="small" @click="showEditModal(category, i)" v-if="isUpdatedPermitted">Edit</Button>
									<Button type="error" size="small" @click="showDeletingModal(category, i)"  :loading="category.isDeleting" v-if="isDeletedPermitted">Delete</Button>
